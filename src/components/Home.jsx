...
function Home() {
  return (
    <div id="home" className=" mx-[4vw] mt-[15vw] md:mt-[3vw] ">   
        ...
        < motion.h1 className=" ease-in font-Inter text-[7vw] md:text-[4vw] -mt-[2vh] md:mt-0 lg:text-[3vw] pl-[1vw] " initial={{  x: '-100%',scale:0 }}   animate={{ x: 0,scale:1 }} transition={{ duration: 1.5 }}>Java Developer @TCS</motion.h1>
